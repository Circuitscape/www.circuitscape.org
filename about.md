...
~~~
<img style="float: right; height: 267px; width: 400px; margin-left: 10px;" src="/assets/img/image16.png" alt="Circuitscape connectivity visualization" />
~~~
...
[**”One glorious map”**](https://www.climatecentral.org/news/map-animal-migration-climate-change-20646) using Circuitscape to model species responses to climate change almost breaks the internet. More [here](https://blog.nature.org/science/2016/08/19/migration-in-motion-visualizing-species-movements-due-to-climate-change/) and [here](https://www.smithsonianmag.com/smart-news/mesmerizing-animation-shows-where-animals-going-survive-climate-change-180960253/).

* Circuitscape wins Wildlife Society award
* [Circuitscape on the cover of Methods in Ecology &amp; Evolution](https://besjournals.onlinelibrary.wiley.com/journal/2041210x)
* [Using Circuitscape to predict HIV spread in Africa](https://www.academia.edu/4707367/Spatial_accessibility_and_the_spread_of_HIV-1_subtypes_and_recombinants)
